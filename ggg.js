...
function addPlanetToRow(planetName, planetDescription) {
  ...
  card.innerHTML = `
    ...
    <button id="myBtnId" onclick="uploadFile()" onchange="hideButtons()">Завантажити</button>
    </div>
...
function hideButtons() {
  var inputButton = document.getElementById("myFileInput");
  var uploadButton = document.getElementById("myBtnId");
